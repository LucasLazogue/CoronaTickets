...
/**
 * <p>Clase Java para dataPaqueteArray complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="item" type="{http://servidor/}dataPaquete" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class DataPaqueteArray {
    ...
    public List<DataPaquete> getItem() {
        if (item == null) {
            item = new ArrayList<DataPaquete>();
        }
        return this.item;
    }
